...
def menu():
    print("""
          ...
          Makine ogrenmesi tabanli Twitter ruh analiz programi
    
    
    Coded by FFH
    """)
    target = input("Hedef ismi girin:")
    asagi_cek = int(input("Sayfayi asagi cekme sayisi:"))
